...
# Need to fix redirect with blank form
...
def validate():
    ...
    if results:
        flash('The email ' + request.form['email'] + ' belongs to a registered account. Please login using ' + request.form['email'] + " or provide a different email. ",  'notice')
        return redirect ('/')
